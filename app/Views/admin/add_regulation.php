                            ...
                            <div class="card-body">
                                <form action="<?= base_url('admin/save_regulation') ?>" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="jenis_peraturan" name="jenis_peraturan" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="kepatuhan" name="kepatuhan" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="isi_peraturan">Isi Peraturan</label>
                                        <textarea class="form-control" id="isi_peraturan" name="isi_peraturan" rows="3" required></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="poin_kritis">Poin Kritis</label>
                                        <textarea class="form-control" id="poin_kritis" name="poin_kritis" rows="3"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="instansi_penerbit">Instansi Penerbit</label>
                                        <input type="text" class="form-control" id="instansi_penerbit" name="instansi_penerbit" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="analisis_risiko">Analisis Risiko</label>
                                        <textarea class="form-control" id="analisis_risiko" name="analisis_risiko" rows="3"></textarea>
                                    </div>
                                    <div class="form-group">
